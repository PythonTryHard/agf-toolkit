...
def encode(
    ...
    # Gear infos
    encoded_type = constants.GEAR_TYPE_MAPPING[gear_type]
    encoded_set = constants.SET_NAME_MAPPING[gear_set]

    # Main stat
    mainstat_type = constants.STAT_TYPE_MAPPING[mainstat_data[0]]
